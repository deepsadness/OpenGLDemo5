...
public class TriangleShapeRender extends ViewGLRender {
    ...
    private static final int TOTAL_COMPONENT_COUNT = COORDS_PER_VERTEX;
    //一个点需要的byte偏移量。
    ...
    private static final int VERTEX_COUNT = TRIANGLE_COORDS.length /COORDS_PER_VERTEX;

    //pragram的指针
    private final int mProgramObjectId;
    //顶点数据的内存映射
...
//        super.onDrawFrame(gl);
        ...
        GLES20.glVertexAttribPointer(
                vPosition,  //上面得到的id
                COORDS_PER_VERTEX , //告诉他用几个便宜量来描述一个顶点
